...
#PULL OUT THE NAMES OF EACH DNA SEQ FROM THE LIST AND THEN PRINT THEM TO THE BEGINNIGN OF THE FILE ALSO PUT A FAKE HEADER FOR THE FIRST ENTRY #N THE LIST SINCE IT SEEMS TO RUN WITH A FALSE START THAT WILL SCREW UP THE NAME ASSIGNMENT.
$LIST = "$ARGV[0]";
$name_count = "$ARGV[1]";
