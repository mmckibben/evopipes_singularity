...
#This script searches through a file and removes rows that contain any of the phrases below - this script is used to remove sequences that are annotated as known TEs.
$NAME = "$ARGV[0]";
